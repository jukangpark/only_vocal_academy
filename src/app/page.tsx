        ...
        <div className="container mx-auto max-w-6xl text-center relative z-10">
          ...
          >
            <div className="inline-block mb-6">
              <span className="text-sm md:text-base font-semibold text-white px-4 py-2 rounded-full">
                About Only Vocal Academy
              </span>
            </div>
            <h2 className="text-4xl md:text-6xl font-bold mb-6 bg-gradient-to-r from-white via-gray-100 to-white bg-clip-text text-transparent drop-shadow-lg">
              보컬트레이닝의 새로운 기준을 만들다.
            </h2>
